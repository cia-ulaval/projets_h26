...
* **GEL / GIF (x2)**
  S’occuper de la communication entre le drone, l’ordinateur central et toutes les pièces du pipeline (C, Python, hardware, autre). Optimisation et minimisation de la latence de transmission. Émulation de la manette pour communiquer avec le Flight Controller.

* **Simulation (x2)**
  Concevoir une simulation du système et des drones avec Isaac Sim (CAD, Python, physique, etc).
